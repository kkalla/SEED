...
def main(args):
    ...
    if args.resume:
        ...
        if 'epoch' in checkpoint.keys():
            ...
            start_epoch = int(start_iters // len(train_loader)
                              ) if not args.evaluate else 0
    ...
    scheduler = optim.lr_scheduler.MultiStepLR(
        optimizer, milestones=[4, 5], gamma=0.1)
    ...
    # Start training
    evaluator.evaluate(test_loader, step=0,
                       tfLogger=eval_tfLogger, dataset=test_dataset)

...
fasttext_model = fasttext.load_model('/pre-trained/cc.en.300.bin')
...
if __name__ == "__main__":
    ...
    lmdb_output_path = '/lmdb/valid'
    gt_file = os.path.join(data_dir, 'annotation_valid.txt')
    ...
    for i, line in enumerate(lines):
        splits = line.split(' ')
        image_name = splits[0].replace('./', '')
        gt_text = image_name.split('_')[-2]

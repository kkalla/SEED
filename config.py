...
# data
parser.add_argument('--synthetic_train_data_dir',
                    nargs='+', type=str, metavar='PATH')
...
parser.add_argument('--evaluate_with_lexicon',
...
parser.add_argument('--real_logs_dir', type=str,
                    metavar='PATH', default='logs/aster.pytorch')
